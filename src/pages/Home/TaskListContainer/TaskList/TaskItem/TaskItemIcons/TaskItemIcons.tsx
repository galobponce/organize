...
const TaskItemIcons: FC<{ edit: () => void, delete: () => void }> = (props) => {
  return (
    <TaskItemIconsContainer>
      <Button size='xs' bg='inherit' rounded='full' onClick={props.edit}>
        <FontAwesomeIcon color='inherit' size='1x' icon={faEdit}></FontAwesomeIcon>
      </Button>
      <Button size='xs' bg='inherit' rounded='full' _hover={{backgroundColor: theme.colors.red[100]}} onClick={props.delete}>
